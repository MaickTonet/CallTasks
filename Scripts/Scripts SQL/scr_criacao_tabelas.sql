...
COMMENT ON COLUMN chamado.codigo_chamado IS 'Código do chamado';
COMMENT ON COLUMN chamado.cnpj_empresa IS 'CNPJ da empresa';
COMMENT ON COLUMN chamado.cpf_usuario IS 'CPF do usuário';
...
COMMENT ON TABLE endereco_empresa IS 'Endereço da empresa';
COMMENT ON COLUMN endereco_empresa.cod_endereco_empresa IS 'Código do endereço da empresa';
COMMENT ON COLUMN endereco_empresa.cnpj_empresa IS 'Chave estrangeira da empresa';
COMMENT ON COLUMN endereco_empresa.cep_endereco IS 'CEP da empresa';
COMMENT ON COLUMN endereco_empresa.rua_endereco IS 'Rua da empresa';
COMMENT ON COLUMN endereco_empresa.bairro_endereco IS 'Bairro da empresa';
COMMENT ON COLUMN endereco_empresa.cidade_endereco IS 'Cidade da empresa';
...
COMMENT ON COLUMN tipo_chamado.cod_tipo_chamado IS 'Código do tipo de chamado';
...
-- Constraints
ALTER TABLE endereco_empresa ADD CONSTRAINT FKendereco_e597786 FOREIGN KEY (cnpj_empresa) REFERENCES empresa (cnpj_empresa);
ALTER TABLE chamado ADD CONSTRAINT FKchamado898041 FOREIGN KEY (cpf_usuario) REFERENCES usuario (cpf_usuario);
ALTER TABLE chamado ADD CONSTRAINT FKchamado686775 FOREIGN KEY (cnpj_empresa) REFERENCES empresa (cnpj_empresa);
ALTER TABLE tipo_chamado ADD CONSTRAINT FKtipo_chamado175715 FOREIGN KEY (codigo_chamado) REFERENCES chamado (codigo_chamado);
ALTER TABLE telefone_empresa ADD CONSTRAINT FKtelefone_empresa997232 FOREIGN KEY (cnpj_empresa) REFERENCES empresa (cnpj_empresa);
ALTER TABLE departamento ADD CONSTRAINT FKdepartamento265819 FOREIGN KEY (cpf_usuario) REFERENCES usuario (cpf_usuario);
ALTER TABLE telefone_usuario ADD CONSTRAINT FKtelefone_usuario327246 FOREIGN KEY (cpf_usuario) REFERENCES usuario (cpf_usuario);
ALTER TABLE historico_chamado ADD CONSTRAINT FKhistorico_chamado313975 FOREIGN KEY (codigo_chamado) REFERENCES chamado (codigo_chamado);
ALTER TABLE historico_chamado ADD CONSTRAINT FKhistorico_chamado572937 FOREIGN KEY (cod_tipo_chamado) REFERENCES tipo_chamado (cod_tipo_chamado);
